...
for(var i= 1; i<=10; i++){
    document.write(multiplica + " multiplicado por "+ i+ " = "+ multiplica*i+"<br>");
}
document.write("<hr>")
...
for(var i= 1; i<=10; i++){
    document.write("<h4>Todas las tablas</h4>");
    for(var e= 1; e<=10; e++){
        document.write(i + " multiplicado por "+ e+ " = "+ e*i+"<br>");
    }
    document.write("<hr>");
}
...
for(var i= 1; i<=multiplica; i++){
    document.write("<h4>Todas las tablas hasta la tabla del "+ multiplica+"</h4>");
    for(var e= 1; e<=10; e++){
        document.write(i + " multiplicado por "+ e+ " = "+ e*i+"<br>");
    }
    document.write("<hr>");
